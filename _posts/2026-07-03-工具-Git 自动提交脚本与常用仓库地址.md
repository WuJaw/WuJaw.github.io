---
layout: post
title: "Git 自动提交脚本与常用仓库地址"
date: 2026-07-03
category: 工具
---

Git 日常操作里最烦的就是写 commit message 和记住一堆克隆地址。本文把两件事收拢到一起：前半部分讲 autocommit 自动提交脚本，后半部分记录常用的 GitHub 仓库地址。
...
[lwrb 环形缓冲区](https://github.com/MaJerle/lwrb)
